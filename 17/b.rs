  ...
  let res = dijkstra(
    ...
    |node| {
      ...
      if node.direction != Direction::Right
        ...
        && !(node.direction == Direction::Left && node.length >= 10)
      {
        res.push(Node {
          x: node.x - 1,
          y: node.y,
      ...
      if node.direction != Direction::Left
        ...
        && !(node.direction == Direction::Right && node.length >= 10)
      {
        res.push(Node {
          x: node.x + 1,
          y: node.y,
      ...
      if node.direction != Direction::Down
        ...
        && !(node.direction == Direction::Up && node.length >= 10)
      {
        res.push(Node {
          x: node.x,
          y: node.y - 1,
      ...
      if node.direction != Direction::Up
        ...
        && !(node.direction == Direction::Down && node.length >= 10)
      {
        res.push(Node {
          x: node.x,
          y: node.y + 1,
